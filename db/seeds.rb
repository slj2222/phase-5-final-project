...
c1 = Client.create(first_name: "Spencer", last_name: "Johnson", phone_number: "555-555-5555", email_address: "yes@gmail.com", total_invoiced: 0, total_collected: 0, company_id: company1.id)
c2 = Client.create(first_name: "Josh", last_name: "Robo", phone_number: "555-555-5555", email_address: "woah@gmail.com", total_invoiced: 0, total_collected: 0, company_id: company1.id)
c3 = Client.create(first_name: "Gary", last_name: "Craig", phone_number: "555-555-5555", email_address: "omg@gmail.com", total_invoiced: 0, total_collected: 0, company_id: company2.id)
c4 = Client.create(first_name: "Jimmy", last_name: "Smith", phone_number: "555-555-5555", email_address: "no@gmail.com", total_invoiced: 0, total_collected: 0, company_id: company2.id)
